...
if (cmd == "stats") {
    ...
    clientMessage("WorldDir: " + "/storage/emulated/0/games/com.mojang/minecraftWorlds/"+Level.getWorldDir());
    clientMessage("Time: " + Level.getTime());
    clientMessage("Rain Level: " + Level.getRainLevel());
    clientMessage("Lightning Level: " + Level.getLightningLevel());
}
